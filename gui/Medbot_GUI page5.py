...
image2_label = canvas.create_image(499, 473, image=image2_tk) #875,473
...
text = "BLOOD \nPRESSURE"
text_label = canvas.create_text(370, 195, text=text, font=("ROBOTO", 12, "bold"), fill="black", justify=tk.CENTER)

text = "OXYGEN \nSATURATION"
text_label = canvas.create_text(740, 195, text=text, font=("ROBOTO", 12, "bold"), fill="black", justify=tk.CENTER)
