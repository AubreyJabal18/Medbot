...
image2 = Image.open("C:\\Users\\elma\\OneDrive\\Desktop\\Medbot\\gui\\images\\vitals\\1.png")
image2_tk = ImageTk.PhotoImage(image2)
image2_label = canvas.create_image(245, 250, image=image2_tk) 

image3 = Image.open("C:\\Users\\elma\\OneDrive\\Desktop\\Medbot\\gui\\images\\vitals\\2.png")
image3_tk = ImageTk.PhotoImage(image3)
image3_label = canvas.create_image(245, 250, image=image3_tk) 

image4 = Image.open("C:\\Users\\elma\\OneDrive\\Desktop\\Medbot\\gui\\images\\vitals\\3.png")
image4_tk = ImageTk.PhotoImage(image4)
image4_label = canvas.create_image(635, 250, image=image4_tk) 

image5 = Image.open("C:\\Users\\elma\\OneDrive\\Desktop\\Medbot\\gui\\images\\vitals\\4.png")
image5_tk = ImageTk.PhotoImage(image5)
image5_label = canvas.create_image(635, 250, image=image5_tk) 

box1 = Image.open("C:\\Users\\elma\\OneDrive\\Desktop\\Medbot\\gui\\images\\button (9).png")
box1_tk = ImageTk.PhotoImage(box1)
box1_label = canvas.create_image(245, 248, image=box1_tk) 

box2 = Image.open("C:\\Users\\elma\\OneDrive\\Desktop\\Medbot\\gui\\images\\button (9).png")
box2_tk = ImageTk.PhotoImage(box2)
box2_label = canvas.create_image(440, 248, image=box2_tk) 

box3 = Image.open("C:\\Users\\elma\\OneDrive\\Desktop\\Medbot\\gui\\images\\button (9).png")
box3_tk = ImageTk.PhotoImage(box3)
box3_label = canvas.create_image(635, 248, image=box3_tk) 

box4 = Image.open("C:\\Users\\elma\\OneDrive\\Desktop\\Medbot\\gui\\images\\button (9).png")
