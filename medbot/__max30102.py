...
class MAX30102():
    ...
    def calc_hr_and_spo2(self, ir_data, red_data):
            ...
            ir_valley_locs, n_peaks = self.__find_peaks(x, BUFFER_SIZE, n_th, 4, 15)
    ...
    def __find_peaks(self, x, size, min_height, min_dist, max_num):
        """
        Find at most MAX_NUM peaks above MIN_HEIGHT separated by at least MIN_DISTANCE
        """
        ir_valley_locs, n_peaks = self.find_peaks_above_min_height(x, size, min_height, max_num)
        ir_valley_locs, n_peaks = self.__remove_close_peaks(n_peaks, ir_valley_locs, x, min_dist)
    ...
    def __remove_close_peaks(self, n_peaks, ir_valley_locs, x, min_dist):
        """
